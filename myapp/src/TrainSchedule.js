...
class TrainSchedule extends Component {
  ...
  render() {
    const { cityStationData, selectedCity, selectedStation, selectedDate, showDatePicker, trainInfo } = this.state;
    const selectedCityData = cityStationData.find(city => city.cityName === selectedCity);
