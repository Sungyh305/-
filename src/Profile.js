      ...
      >
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            ...
            <TextInput style={styles.input} onChangeText={setAdditional} value={additional} placeholder="기타" />
            <TextInput style={styles.input} onChangeText={setPersonal} value={personal} placeholder="개인" />
            <TextInput style={styles.input} onChangeText={setInformation} value={information} placeholder="정보" />
