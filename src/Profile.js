...
import { StyleSheet, View, Text, TouchableOpacity, Modal, TextInput, Alert, Image } from 'react-native';
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <TouchableOpacity style={styles.iconButtonRight} onPress={openEditModal}>
      ...
      >
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            ...
            <TextInput style={styles.input} onChangeText={setEmail} value={email} placeholder="Edit Email" />
            <TextInput style={styles.input} onChangeText={setAdditional} value={additional} placeholder="Edit Additional Info" />
            <TextInput style={styles.input} onChangeText={setPersonal} value={personal} placeholder="Edit Personal Info" />
            <TextInput style={styles.input} onChangeText={setInformation} value={information} placeholder="Edit Information" />
